...
#
  ...
  resource "aws_instance" "introducer" {
    ...
    inline = [
      "sudo rm -rf /home/ubuntu/chia-blockchain/ && sudo mkdir /home/ubuntu/chia-blockchain && sudo chown -R ubuntu:ubuntu /home/ubuntu/chia-blockchain && mkdir /home/ubuntu/.chia/config",
    ]
    connection {
      type        = "ssh"
