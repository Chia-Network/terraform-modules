...
resource "aws_instance" "plotter" {
  ...
  provisioner "remote-exec" {
    inline = [
    "cd ./chiapos",
    "sudo mkfs.ext4 /dev/nvme1n1 && sudo mkdir /mnt/plots && sudo mount /dev/nvme1n1 /mnt/plots && sudo mkdir /mnt/plots/temp && /mnt/plots/final && sudo chown -r ubuntu:ubuntu /mnt/plots",
